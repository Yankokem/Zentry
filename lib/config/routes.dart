...
// Import your screens here when you create them
    ...
    switch (settings.name) {
      case splash:
        ...
        return MaterialPageRoute(
          builder: (_) => const Placeholder(), // Replace with actual screen
        );
      
      case login:
        return MaterialPageRoute(
          builder: (_) => const Placeholder(), // Replace with LoginScreen()
        );
      ...
      case home:
        return MaterialPageRoute(
          builder: (_) => const Placeholder(), // Replace with HomeScreen()
        );
