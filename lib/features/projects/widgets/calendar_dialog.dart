...
class _CalendarDialogState extends State<CalendarDialog> {
  ...
  Set<DateTime> _getDeadlineDates(List<Ticket> tickets) {
  ...
  List<Ticket> _getTicketsForDate(DateTime date, List<Ticket> tickets) {
    ...
    return Dialog(
      ...
      child: Container(
        ...
        child: StreamBuilder<List<Ticket>>(
          stream: _projectManager.listenToUserTickets(),
          builder: (context, snapshot) {
            ...
            final deadlineDates = _getDeadlineDates(tickets);
            ...
            return Column(
              ...
              children: [
                  ...
                  calendarBuilders: CalendarBuilders(
                    markerBuilder: (context, date, events) {
                      if (events.isNotEmpty) {
                        ...
                        final ticketsForDate = _getTicketsForDate(date, tickets);
                ...
                if (_selectedDay != null) ...[
                  ...
                  ..._getTicketsForDate(_selectedDay!, tickets).map((ticket) => Card(
                  ...
                  if (_getTicketsForDate(_selectedDay!, tickets).isEmpty)
                    Text(
